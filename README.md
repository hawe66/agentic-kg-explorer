...
│   │   └── __init__.py
│   ├── agents/            # LangGraph 에이전트들 (🔜 Phase 2)
...
- [x] Neo4j 클라이언트 구현 (`src/graph/client.py`)
- [x] Pydantic 모델 정의 (`src/graph/schema.py`)
- [x] Seed 데이터 작성 (`neo4j/seed_data.cypher`)
